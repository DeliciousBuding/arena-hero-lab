...
- `src/data/platform.json` is generated and freshness-checked as release evidence, but the
  public Leaderboard does not render it. The user-facing site remains a rankings-only
  benchmark and replay explorer.
